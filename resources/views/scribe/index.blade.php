    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="autenticacion">
                    <a href="#autenticacion">Autenticación</a>
                                ...
                                <a href="#autenticacion-POSTapi-v1-register">Registro de usuario</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="autenticacion-POSTapi-v1-login">
                                <a href="#autenticacion-POSTapi-v1-login">Inicio de sesión</a>
                            </li>
                                ...
                                <a href="#autenticacion-POSTapi-v1-logout">Cerrar sesión</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="autenticacion-GETapi-v1-profile">
                                <a href="#autenticacion-GETapi-v1-profile">Perfil del usuario</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="tareas">
                    <a href="#tareas">Tareas</a>
                                    ...
                                    <ul id="tocify-subheader-tareas" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="tareas-GETapi-v1-tasks">
                                <a href="#tareas-GETapi-v1-tasks">Listar tareas</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tareas-POSTapi-v1-tasks">
                                <a href="#tareas-POSTapi-v1-tasks">Crear tarea</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tareas-GETapi-v1-tasks--id-">
                                <a href="#tareas-GETapi-v1-tasks--id-">Ver tarea</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tareas-PUTapi-v1-tasks--id-">
                                <a href="#tareas-PUTapi-v1-tasks--id-">Actualizar tarea</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="tareas-DELETEapi-v1-tasks--id-">
                                <a href="#tareas-DELETEapi-v1-tasks--id-">Eliminar tarea</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>Endpoints para registro, inicio de sesión y cierre de sesión.</p>

                                <h2 id="autenticacion-POSTapi-v1-register">Registro de usuario</h2>

<p>
</p>

<p>Crea un nuevo usuario y devuelve un token de acceso.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Correo electrónico. Example: <code>juan@mail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Confirmación de contraseña. Example: <code>secret123</code></p>
        </div>
        </form>

                    <h2 id="autenticacion-POSTapi-v1-login">Inicio de sesión</h2>

<p>
</p>

<p>Autentica un usuario y devuelve un token de acceso.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="autenticacion-GETapi-v1-profile">Perfil del usuario</h2>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Endpoints para gestionar tareas (CRUD). Todos requieren autenticación.</p>

                                <h2 id="tareas-GETapi-v1-tasks">Listar tareas</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Obtiene una lista paginada de tareas del usuario autenticado.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/tasks?page=1&amp;per_page=15" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
    ...
    &quot;data&quot;: [
        {
            &quot;id&quot;: 1,
            &quot;title&quot;: &quot;Mi tarea&quot;,
            &quot;description&quot;: &quot;Descripci&oacute;n de la tarea&quot;,
            &quot;status&quot;: &quot;pending&quot;,
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="page"                data-endpoint="GETapi-v1-tasks"
               value="1"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="per_page"                data-endpoint="GETapi-v1-tasks"
               value="15"
               data-component="query">
    <br>
<p>Items por página. Example: <code>15</code></p>
                    ...
                    <h2 id="tareas-POSTapi-v1-tasks">Crear tarea</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Crea una nueva tarea para el usuario autenticado.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Comprar víveres"
               data-component="body">
    <br>
<p>Título de la tarea. Example: <code>Comprar víveres</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Leche, pan, huevos"
               data-component="body">
    <br>
<p>Descripción de la tarea. Example: <code>Leche, pan, huevos</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Estado: pending, in_progress, completed. Example: <code>pending</code></p>
        </div>
        </form>

                    <h2 id="tareas-GETapi-v1-tasks--id-">Ver tarea</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Muestra los detalles de una tarea específica.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task"                data-endpoint="GETapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>ID de la tarea. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="tareas-PUTapi-v1-tasks--id-">Actualizar tarea</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Actualiza los datos de una tarea existente.</p>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        &quot;id&quot;: 1,
        &quot;title&quot;: &quot;Comprar v&iacute;veres actualizado&quot;,
        &quot;description&quot;: &quot;Solo leche y pan&quot;,
        &quot;status&quot;: &quot;in_progress&quot;,
        &quot;created_at&quot;: &quot;2026-06-11T12:00:00.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2026-06-11T12:00:00.000000Z&quot;
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task"                data-endpoint="PUTapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>ID de la tarea. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Comprar víveres actualizado"
               data-component="body">
    <br>
<p>Título de la tarea. Example: <code>Comprar víveres actualizado</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Solo leche y pan"
               data-component="body">
    <br>
<p>Descripción de la tarea. Example: <code>Solo leche y pan</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Estado: pending, in_progress, completed. Example: <code>in_progress</code></p>
        </div>
        </form>

                    <h2 id="tareas-DELETEapi-v1-tasks--id-">Eliminar tarea</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Elimina una tarea del sistema.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task"                data-endpoint="DELETEapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>ID de la tarea. Example: <code>1</code></p>
